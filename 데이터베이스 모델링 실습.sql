...
insert into `Professors` values ('P10101', 10, '김유신', '750120-1234567', '010-1101-197', 'kimys@hg.ac.kr', '서울');
...
insert into `Students` (`stdNo`,`depNo`,`proNo`,`stdName`,`stdJumin`,`stdHp`,`stdAddr`) values ('20101001', 10, 'P10101', '정우성', '760121-1234567', '010-1101-7607', '서울');
