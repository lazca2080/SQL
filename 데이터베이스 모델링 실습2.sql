insert into `departments` values ('101', '소아과', '김유신', '051-123-01');
insert into `departments` values ('102', '내과', '김춘추', '051-123-01');
insert into `departments` values ('103', '외과', '장보고', '051-123-01');
insert into `departments` values ('104', '피부과', '선덕여왕', '051-123-01');
insert into `departments` values ('105', '이비인후과', '강감찬', '051-123-01');
insert into `departments` values ('106', '산부인과', '신사임당', '051-123-01');
insert into `departments` values ('107', '흉부외과', '류성룡', '051-123-01');
insert into `departments` values ('108', '정형외과', '송상현', '051-123-01');
insert into `departments` values ('109', '신경외과', '이순신', '051-123-01');
insert into `departments` values ('110', '비뇨기과', '정약용', '051-123-01');
insert into `departments` values ('111', '안과', '박지원', '051-123-01');
insert into `departments` values ('112', '치과', '전봉준', '051-123-01');
...
insert into `Patients` values ('P103102', 'D103101', 'N103101', '장동건', '790728-1234567', 'M', '대구', '010-3101-7907', 'jang@nave.com', '배우');
